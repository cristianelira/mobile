...
export default function Index() {
  ...
  function handleNextStepForm() {
    ...
    if (destination.length < 4) {
      return Alert.alert(
        'Detalhes da viagem',
        'Destino deve ter ao menos 4 caracteres'
      )
    }
  ...
  function handleAddEmail() {
    if (!validateInput.email(emailToInvite)) {
      return Alert.alert('Convidado', 'E-mail do convidado invalido')
    }
  ...
  async function saveTrip(tripId: string) {
    try {
      ...
      Alert.alert('Salvar viagem', 'Não foi possivel salvar o ID da viagem')
      console.log(error)
    }
  }
  ...
  return (
    <View className="flex-1 items-center justify-center px-5">
      ...
      <Text className="text-zinc-500 font-regular text-center text-base">
        ...
        nossos <Text className="text-zinc-300 underline">termos de uso.</Text>
      </Text>
